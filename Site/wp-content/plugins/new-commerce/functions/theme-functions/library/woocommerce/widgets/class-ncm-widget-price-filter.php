 ...
 * @extends  WC_Widget
 */
class NCM_WC_Widget_Price_Filter extends WC_Widget_Price_Filter
{
    /**
     * Constructor.
     */
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($_GET['view'])) {
            $fields .= '<input type="hidden" name="view" value="' . esc_attr($_GET['view']) . '" />';
        }
        ...
        echo '<form method="get" action="' . esc_url($form_action) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<button type="submit" class="ncm-button">' . __('Filter', 'woocommerce') . '</button>
					<div class="price_label" style="display:none;">
						'.__( 'Price:', 'woocommerce' ).' <span class="from patternTextColor"></span> &mdash; <span class="to patternTextColor"></span>
					</div>
					' . $fields . '
					<div class="clear"></div>
				</div>
...
class NCM_WC_Widget_Price_Filter extends WC_Widget_Price_Filter {
	...
	function widget( $args, $instance ) {
		...
		if (isset($_GET['view'])) $fields .= '<input type="hidden" name="view" value="' . esc_attr( $_GET['view'] ) . '" />';
