		...
		<thead>
			<tr>
				<?php foreach (wc_get_account_downloads_columns() as $column_id => $column_name) : ?>
                    <th class="order-number <?php echo esc_attr($column_id); ?>">
                        <span class="rotated">&gt;</span>&nbsp;&nbsp;&nbsp;<?php echo esc_html($column_name); ?>
                    </th>
                <?php endforeach; ?>
			</tr>
		</thead>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file ncm-button patternBGColor alt">' . esc_html( $download['download_name'] ) . '</a>';
									break;
