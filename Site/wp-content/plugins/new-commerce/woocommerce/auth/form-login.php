...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="ncm-button patternBGColor button-large button-primary wc-auth-login-button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
