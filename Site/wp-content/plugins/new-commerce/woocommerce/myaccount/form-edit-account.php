        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <form class="edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
                    ...
                    <h3><?php esc_html_e("Account Details", NCM_I18N_DOMAIN); ?></h3>
                    ...
                    <fieldset>
                        <h3 class="margin-top-16"><?php esc_html_e('Password Change', 'woocommerce'); ?></h3>
                    ...
                    <p>
                        ...
                        <input type="submit" class="ncm-button patternBGColor" name="save_account_details" value="<?php esc_attr_e('Save changes', 'woocommerce'); ?>"/>
