	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
                ...
                <input type="submit" class="ncm-button fll" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
                <input type="hidden" name="redirect" value="<?php echo esc_url( $redirect ) ?>" />
                <label id="label-remember" for="rememberme" class="fll">
                    <input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Remember me', 'woocommerce' ); ?>
                </label>

                <p class="lost_password flr">
