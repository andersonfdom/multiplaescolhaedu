...
<div class="container">
	<div class="<?php echo ($ncm_blog_is_grid ? "row-fluid" : "row"); ?>">
		...
		<div class="<?php echo ($ncm_blog_is_grid ? "span12" : "span8"); ?> <?php echo ncm_set_blog_position_relative_to_sidebar(); ?>">
			<div id="wrapperBlog">
				<div id="archive">
					<div class="archiveTitle"><?php echo __("Posts tagged with", NCM_I18N_DOMAIN); ?> <span class="patternTextColor">"<?php single_tag_title(); ?>"</span></div>
					<div class="archiveDescription"><?php echo tag_description(); ?></div>
				</div>
				...
				<?php if(!have_posts()) : ?>
					...
					<div class="<?php foreach(get_post_class() as $post_class) echo($post_class . " ") ?> <?php echo ($ncm_blog_is_grid ? "grid-404" : ""); ?> post">
						...
						<p><?php echo __("Sorry, but this blog doesn't have posts tagged with", NCM_I18N_DOMAIN);?> "<?php single_tag_title(); ?>".</p>
