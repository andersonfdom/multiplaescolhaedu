#pragma checksum "D:\Projetos\multiplaescolhaedu\MultiplaEscolhaEdu.Admin\Views\Matriculas\Cadastro.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b47b624b5ae34efdd3da5de293b0ccbc947a2503"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b47b624b5ae34efdd3da5de293b0ccbc947a2503", @"/Views/Matriculas/Cadastro.cshtml")]
            ...
            $.ajax({
                ...
                success: function (jsonResult) {
                    if (jsonResult.sucesso === true) {
                        ...
                        $('#popMensag");
            WriteLiteral(@"emErro').modal('show');
    ...
    ");
        ...
        function ListarParceiros() {
            ...
            $.ajax({
                ...
                success: function (jsonResult) {
                    jsonResult.forEach(c => {
                        parceiros += ""<option value="" + c.id +");
            WriteLiteral(@" "">"" + c.nomeCompleto + ""</option>"";
                    });
