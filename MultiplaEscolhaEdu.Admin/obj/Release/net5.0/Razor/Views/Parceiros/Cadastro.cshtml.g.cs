#pragma checksum "D:\Projetos\multiplaescolhaedu\MultiplaEscolhaEdu.Admin\Views\Parceiros\Cadastro.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "26e0bd2c4b7e2b5e46d9db2108d248828b6c9c5d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"26e0bd2c4b7e2b5e46d9db2108d248828b6c9c5d", @"/Views/Parceiros/Cadastro.cshtml")]
...
<script>
    $(function () {
            ...
            $.ajax({
                ...
                success: function (jsonResult) {
                    $(jsonResult.mensagem).each(function () {
                        ...
                        document.getEle");
            WriteLiteral(@"mentById(""complemento"").value = this.complemento;
        ...
        $('#btnSalvar').click(function () {
            ...
            WriteLiteral(@"o"", document.getElementById(""complemento"").value);
                ...
                $.ajax({
                    ...
                    success: function (jsonResult) {
                        if (jsonResult.sucesso === true) {
                            ...
                            $('#po");
            WriteLiteral(@"pMensagemErro').modal('show');
    ...
    function camposValidos() {
        ...
        if (document.getElementById('email').value === '') {
            alert('Campo ob");
            WriteLiteral(@"rigatório não preenchido: E-mail ');
...
");
            WriteLiteral(@"        var posicaoCampo = 0;
        var NovoValorCampo = """";
    ...
    function mascaraInteiro() {
        if (event.keyCode ");
            WriteLiteral(@"< 48 || event.keyCode > 57) {
            event.returnValue = false;
            return false;
        }
        return true;
    ...
    <div class=""tab-content"" id=""myTabContent"">
        <div class=""tab-pane fade show active"" id=""dados-cadastrais"" role=""tabpanel"" aria-labelledby=""home-tab"">
            <div class=""table-responsive"" style=""overflow-x: auto"">
                ...
                ");
            WriteLiteral(@"            <input type=""text"" class=""form-control"" id=""nome"" maxlength=""200"" />
                        </td>
                    </tr>
                </table>
                <table class=""table"" style=""width: 100%"">
                ...
                <table class=""table"" style=""width: 100%"">
                    ...
                    <tr>
                        <td><input type=""text"" class=""form-control"" id=""cep"" ma");
            WriteLiteral(@"xlength=""10"" onfocusout=""buscarCep(this.value)"" onkeypress=""mascaraCep(this)"" /></td>
                ...
                <table class=""table"" style=""width: 100%"">
                    ...
                    <tr>
                        <td><input type=""text"" class=""form-con");
            WriteLiteral(@"trol"" id=""cidade"" maxlength=""200"" /></td>
