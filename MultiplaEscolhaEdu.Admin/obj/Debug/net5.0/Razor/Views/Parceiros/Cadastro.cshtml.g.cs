#pragma checksum "D:\Projetos\multiplaescolhaedu\MultiplaEscolhaEdu.Admin\Views\Parceiros\Cadastro.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e5ce386729b9859dedfe01c0ae3a6aafff309ac3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e5ce386729b9859dedfe01c0ae3a6aafff309ac3", @"/Views/Parceiros/Cadastro.cshtml")]
...
<script>
                ...
                $.ajax({
                    ...
                    success: function (jsonResult) {
                        if (jsonResult.sucesso === true) {
                            ...
                            $('#popMe");
            WriteLiteral(@"nsagemErro').modal('show');
    ...
    function formataCampo(campo, Mascara, evento) {
        ...
        var NovoValorCampo = """";
     ");
            WriteLiteral(@"   var TamanhoMascara = campoSoNumeros.length;;
                ...
                <table class=""table"" style=""width: 100%"">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type=""text"" class=""form-control"" id=""nome"" maxlengt");
            WriteLiteral(@"h=""200"" />
                        </td>
                    </tr>
                </table>
                ...
                <table class=""table"" style=""width: 100%"">
                    ...
                    <tr>
                        <td><input type=""text"" class=""form-control"" id=""cep"" maxlength=""10"" onfocusout=""buscarCep(this.value)"" onkeypress=""mascaraCep");
            WriteLiteral(@"(this)"" /></td>
                ...
                <table class=""table"" style=""width: 100%"">
                    ...
                    <tr>
                        ...
                        <td");
            WriteLiteral(@"><input type=""text"" class=""form-control"" id=""estado"" maxlength=""200"" /></td>
                    </tr>
                </table>
                <table class=""table"" style=""width: 100%"">
                    <tr>
                    ...
                    <tr>
                        <td><input type=""button"" class=""btn btn-primary"" id=""btnSalvar"" value=""Salvar"" />&nbsp;<input type=""button"" class=""btn btn-danger"" id=""btnCancelar"" value=""Cancelar"" onclick=""window.location.href = '/Parceiros/Index'"" /></td>
                    </tr>
                </table>
            </div>
        </div>
