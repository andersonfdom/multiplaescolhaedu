#pragma checksum "D:\Projetos\multiplaescolhaedu\MultiplaEscolhaEdu.Admin\Views\Cursos\Cadastro.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "043b44bde7d4139ae16e10613bec507c86fbb524"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"043b44bde7d4139ae16e10613bec507c86fbb524", @"/Views/Cursos/Cadastro.cshtml")]
...
#nullable disable
    ...
    $(function () {
        ...
        $.ajax({
            type: ""GET"",
            url: ""/Cursos/ListarCategoriaCursos"",
            dataType: ""json"",
            ...
            success: function (jsonResult) {
                if (jsonResult.sucesso == true) {
                    ...
                    $(jsonResult.mensagem).each(function () {
                        categorias += ""<option value=""+this.id+"">""+this.descricao+""</option>""
                    });
                    $('#ddlCategoria').html(categorias);
                } else {
    ...
    function CamposValidosCategoriaCurso() {
        $('#mensagemErro').hide();
        if ($('#txtDescricaoCategoria').val() === '') {
            $('#mensagemErro').show();
            $('#mensagemErro').html(""Campo obrigatório não preenchido: Descrição"");
     ");
            WriteLiteral(@"       $('#txtDescricaoCategoria').focus();
        } else {
            $('#mensagemErro').hide();
            GravarCategoriaCurso();
        }
    }

    function GravarCategoriaCurso() {
         $('#popCategoria').modal('hide');
    }
</script>
            ...
            WriteLiteral(@"     </div>
                                        <div class=""modal-footer"">
                                            <table class=""table"" style=""width: 100%"">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type=""button"" id=""btnSalvarCategoria"" value=""Salvar"" class=""btn btn-primary"" onclick=""CamposValidosCategoriaCurso();"" />
                                                        <input type=""button"" id=""btnCancelarCategoria"" value=""Cancelar"" class=""btn btn-dange");
            WriteLiteral(@"r"" onclick=""$('#popCategoria').modal('hide');"" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
